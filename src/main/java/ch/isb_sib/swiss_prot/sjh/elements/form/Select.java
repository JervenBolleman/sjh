...
public class Select extends CommonElement implements FlowContent,
	...
	protected Stream<Attribute> getElementSpecificAttributes() {
		return Stream.of(this.autoComplete, this.autofocus, this.disabled,
				this.form, this.multiple, this.name, this.required,
				this.size).filter(Objects::nonNull);
	}
}
