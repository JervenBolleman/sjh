 ...
 * 
 * The open attribute is a boolean attribute. When specified, it indicates that
 * the dialog element is active and that the user can interact with it.
 * 
 * A dialog element without an open attribute specified should not be shown to
 * the user. This requirement may be implemented indirectly through the style
 * layer. For example, user agents that support the suggested default rendering
 * implement this requirement using the CSS rules described in the rendering
 * section.
 *
 * 
 */
