...
public class Elements {
	...
	return new Video(new GlobalAttribute[] { id }, null, null, null, null, null, null, null, null, null, null,
		(Height) null, Stream.<Track> empty());
    }
	...
	return new Object(new GlobalAttribute[] { id }, null, null, null, null, null, null, null, null, params);
    }
	...
	return new Object(new GlobalAttribute[] { clazz }, null, null, null, null, null, null, null, null, params);
    }
	...
	return new Video(new GlobalAttribute[] { clazz }, null, null, null, null, null, null, null, null, null, null,
		(Height) null, tracks);
    }
	...
	return new Video(new GlobalAttribute[] { id, clazz }, null, null, null, null, null, null, null, null, null,
		null, (Height) null, Stream.<Track> empty());
    }
	...
	return new Object(new GlobalAttribute[] { id, clazz }, null, null, null, null, null, null, null, null, params);
    }
	...
	return new Video(new GlobalAttribute[] { id, clazz }, null, null, null, null, null, null, null, null, null,
		null, (Height) null, Stream.of(tracks));
    }
	...
	return new A(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Abbr abbr(Id id, Clazz clazz, String string) {
	return new Abbr(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static B b(Id id, Clazz clazz, String string) {
	return new B(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Bdi bdi(Id id, Clazz clazz, String string) {
	return new Bdi(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Bdo bdo(Id id, Clazz clazz, String string) {
	return new Bdo(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Cite cite(Id id, Clazz clazz, String string) {
	return new Cite(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Code code(Id id, Clazz clazz, String string) {
	return new Code(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Data data(Id id, Clazz clazz, String string) {
	return new Data(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)), null);
    }

    public static Dfn ffn(Id id, Clazz clazz, String string) {
	return new Dfn(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Em em(Id id, Clazz clazz, String string) {
	return new Em(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static I i(Id id, Clazz clazz, String string) {
	return new I(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Kbd kbd(Id id, Clazz clazz, String string) {
	return new Kbd(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Mark mark(Id id, Clazz clazz, String string) {
	return new Mark(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Q q(Id id, Clazz clazz, String string) {
	return new Q(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)), null);
    }

    public static S s(Id id, Clazz clazz, String string) {
	return new S(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Samp samp(Id id, Clazz clazz, String string) {
	return new Samp(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Small small(Id id, Clazz clazz, String string) {
	return new Small(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Span span(Id id, Clazz clazz, String string) {
	return new Span(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Strong strong(Id id, Clazz clazz, String string) {
	return new Strong(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Sub sub(Id id, Clazz clazz, String string) {
	return new Sub(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Sup sup(Id id, Clazz clazz, String string) {
	return new Sup(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static U u(Id id, Clazz clazz, String string) {
	return new U(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Var var(Id id, Clazz clazz, String string) {
	return new Var(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }
	...
	return new H1(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static H2 h2(Id id, Clazz clazz, String string) {
	return new H2(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static H3 h3(Id id, Clazz clazz, String string) {
	return new H3(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static H4 h4(Id id, Clazz clazz, String string) {
	return new H4(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static H5 h5(Id id, Clazz clazz, String string) {
	return new H5(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static H6 h6(Id id, Clazz clazz, String string) {
	return new H6(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Address address(Id id, Clazz clazz, String string) {
	return new Address(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Article article(Id id, Clazz clazz, String string) {
	return new Article(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Aside aside(Id id, Clazz clazz, String string) {
	return new Aside(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Body body(Id id, Clazz clazz, String string) {
	return new Body(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Footer footer(Id id, Clazz clazz, String string) {
	return new Footer(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Header header(Id id, Clazz clazz, String string) {
	return new Header(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Nav nav(Id id, Clazz clazz, String string) {
	return new Nav(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Section section(Id id, Clazz clazz, String string) {
	return new Section(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static BlockQuote BlockQuote(Id id, Clazz clazz, String string) {
	return new BlockQuote(new GlobalAttribute[] { id, clazz }, null, Stream.of(new Text(string)));
    }

    public static Div Div(Id id, Clazz clazz, String string) {
	return new Div(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static LI LI(Id id, Clazz clazz, String string) {
	return new LI(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)), null);
    }

    public static Main Main(Id id, Clazz clazz, String string) {
	return new Main(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static P P(Id id, Clazz clazz, String string) {
	return new P(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }

    public static Pre Pre(Id id, Clazz clazz, String string) {
	return new Pre(new GlobalAttribute[] { id, clazz }, Stream.of(new Text(string)));
    }
