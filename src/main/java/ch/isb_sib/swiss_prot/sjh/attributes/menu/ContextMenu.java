 ...
 * the ID of a menu element in the same tree whose type attribute is in the
 * context menu state.
 * 
 * When a user right-clicks on an element with a contextmenu attribute, the user
 * agent will first fire a contextmenu event at the element, and then, if that
 * event is not canceled, a show event at the menu element.
 * 
