...
public non-sealed class Bdo extends CommonElement implements FlowContent, PhrasingContent, PalpabaleContent {
    ...
    public Bdo(Stream<GlobalAttribute> ga, Stream<? extends PhrasingContent> childeren) {
        super(ga, childeren);
    }
}
