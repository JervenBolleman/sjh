...
public non-sealed class Div extends CommonElement implements FlowContent, PalpabaleContent {
    ...
    public Div(Stream<GlobalAttribute> ga, Stream<RdfaAttribute> rdfa, Stream<? extends FlowContent> childeren) {
