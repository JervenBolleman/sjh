...
import swiss.sib.swissprot.sjh.elements.embedded.Param;
import swiss.sib.swissprot.sjh.elements.embedded.Source;
...
import swiss.sib.swissprot.sjh.elements.form.Legend;
import swiss.sib.swissprot.sjh.elements.form.Meter;
import swiss.sib.swissprot.sjh.elements.form.OptGroup;
import swiss.sib.swissprot.sjh.elements.form.Option;
import swiss.sib.swissprot.sjh.elements.form.OptionOrOptGroup;
...
import swiss.sib.swissprot.sjh.elements.grouping.FigCaption;
...
import swiss.sib.swissprot.sjh.elements.meta.Base;
...
import swiss.sib.swissprot.sjh.elements.table.Caption;
import swiss.sib.swissprot.sjh.elements.table.Col;
import swiss.sib.swissprot.sjh.elements.table.ColGroup;
import swiss.sib.swissprot.sjh.elements.table.ColOrTemplate;
import swiss.sib.swissprot.sjh.elements.table.TBody;
import swiss.sib.swissprot.sjh.elements.table.TD;
import swiss.sib.swissprot.sjh.elements.table.TDOrTH;
import swiss.sib.swissprot.sjh.elements.table.TFoot;
import swiss.sib.swissprot.sjh.elements.table.TH;
import swiss.sib.swissprot.sjh.elements.table.THead;
...
public class Elements {
    ...
    public static Input input(Id id, Clazz clazz, swiss.sib.swissprot.sjh.attributes.form.Type type) {
        return new Input(ga(id, clazz), type);
    }

    public static Input input(Id id, Clazz clazz, swiss.sib.swissprot.sjh.attributes.form.Type type, Checked checked,
            Disabled disabled) {
    ...
    public static Col col(Id id, String span) {
        return new Col(ga(id), new swiss.sib.swissprot.sjh.attributes.table.Span(span));
    }
    ...
    public static Col col(Clazz clazz, String span) {
        return new Col(ga(clazz), new swiss.sib.swissprot.sjh.attributes.table.Span(span));
    }
